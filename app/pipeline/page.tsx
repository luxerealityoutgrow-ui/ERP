      ...
      <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm text-left">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-zinc-50 border border-zinc-150 rounded-2xl flex items-center gap-4">
            <div className="p-2.5 rounded-xl bg-white border border-zinc-200 text-zinc-600 shadow-3xs">
          ...
          <div className="p-4 bg-zinc-50 border border-zinc-150 rounded-2xl sm:col-span-2 lg:col-span-1">
            <div className="flex justify-between items-start mb-2">
              ...
              <span className="text-xs font-black text-emerald-600 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-md shadow-3xs">{metrics.progressPercent}%</span>
            </div>
            {/* Linear Progress Bar */}
            ...
            >
              ...
              <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-2">
                  <span className={`h-2.5 w-2.5 rounded-full ${config.indicatorColor} shadow-sm`} />
                  <span className="text-xs font-black text-zinc-900 uppercase tracking-wider">{stageName}</span>
                  <span className="px-1.5 py-0.2 rounded bg-zinc-100 border border-zinc-200 text-[9px] font-black text-zinc-500">
                    {stageDeals.length}
                  </span>
                </div>
              ...
              {/* Column Dropzone */}
              <div 
                className={`flex-1 rounded-3xl p-3 border transition-all duration-200 min-h-[520px] flex flex-col gap-3 ${
                  isDraggingOver 
                    ? 'bg-zinc-100/60 border-zinc-400 border-dashed' 
              ...
              >
                {stageDeals.map((deal) => (
                  <div
                    ...
                    className="bg-white border border-zinc-200 p-4 rounded-2xl shadow-3xs hover:shadow-md hover:border-zinc-900/40 transition-all cursor-grab active:cursor-grabbing group select-none"
                  >
                    <div className="flex items-start justify-between mb-3 gap-2">
                      ...
                      <span className="text-[10px] font-black text-zinc-950 shrink-0">
                    ...
                    <div className="flex items-center justify-between border-t border-zinc-100 pt-3 text-[9px] font-bold text-zinc-400">
                      <span className="uppercase tracking-widest bg-zinc-100 border border-zinc-200 px-1.5 py-0.5 rounded text-zinc-500 scale-95 origin-left">
                        {deal.source}
                      </span>
            ...
            <form onSubmit={handleSaveAdd}>
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full bg-zinc-50 border border-zinc-250 rounded-xl px-3 py-2.5 text-xs text-zinc-900 focus:outline-none focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400/20 transition-all"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select 
                      ...
                      className="w-full bg-zinc-50 border border-zinc-250 rounded-xl px-3 py-2.5 text-xs text-zinc-900 focus:outline-none focus:border-zinc-400 transition-all"
                    >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea 
                    ...
                    className="w-full h-20 bg-zinc-50 border border-zinc-250 rounded-xl px-3 py-2.5 text-xs text-zinc-900 focus:outline-none focus:border-zinc-400 transition-all resize-none"
                  />
                </div>
              </div>
              ...
              <div className="p-6 border-t border-zinc-100 bg-zinc-50/50 flex items-center justify-end gap-3">
                <button 
                  ...
                  className="px-4 py-2 rounded-xl text-xs font-bold text-zinc-500 hover:text-zinc-950 transition-colors"
                >
                  Cancel
                </button>
                <button 
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-zinc-900 text-white text-xs font-bold hover:bg-zinc-800 transition-all shadow-md shadow-zinc-900/10"
                >
                  Create Deal
                </button>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150 text-left">
            ...
            <form onSubmit={handleSaveEdit}>
              ...
              <div className="p-6 border-t border-zinc-100 bg-zinc-50/50 flex items-center justify-between gap-3">
                {/* Delete Deal Button */}
                <button 
                  type="button"
                  onClick={() => handleDeleteDeal(selectedDeal.id)}
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold text-rose-600 hover:bg-rose-50 border border-transparent hover:border-rose-100 transition-all"
                >
