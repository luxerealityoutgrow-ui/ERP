...
export const CalendarContextProvider = ({ children }: PropsWithChildren) => {
    ...
    return <AriaCalendarContext.Provider value={{ value, onChange: onChange as any, focusedValue, onFocusChange: onFocusChange as any }}>{children}</AriaCalendarContext.Provider>;
};
