    ...
    <form action={formAction} className="min-h-screen bg-[#fafaf8]">
      ...
      <div className="sticky top-0 z-10 bg-white border-b border-[#ebebeb] px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-400 font-medium">Luxe Realty Pune · {sections[activeSection].label}</p>
          </div>
        </div>
      ...
      <div className="flex" style={{minHeight:'calc(100vh - 65px)'}}>
        ...
        <div className="flex-1 px-8 py-6 max-w-2xl">
          ...
          {/* 🛑 Duplicate Mobile Warning Modal / Banner */}
          {(state as any)?.duplicate && (state as any)?.existingLead && (
            <div className="mb-6 p-4 bg-rose-50 border border-rose-200 rounded-2xl space-y-3 animate-in zoom-in-95 duration-150 text-left">
          ...
          {(state as any)?.error && !(state as any)?.duplicate && (
            <div className="mb-6 p-4 bg-rose-50 text-rose-600 border border-rose-100 rounded-xl text-[11px] font-bold shadow-xs">
          ...
          {activeSection === 0 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[9.5px] text-zinc-400 italic">Main deciding element. CRM automatically checks for duplicate numbers.</p>
              </div>
          ...
          {/* ── SECTION 1: Classify & Assign ── */}
          {activeSection === 1 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              
              {/* ASSIGNED TO REPRESENTATIVE SELECTOR DIRECTLY IN FORM */}
              <div className="space-y-1.5">
                <label className="text-[9.5px] font-extrabold text-[#b8922e] uppercase tracking-[0.1em] flex items-center gap-1">
                  <User className="h-3 w-3" /> Assigned Representative (Assign To) *
                </label>
                ...
                <p className="text-[9.5px] text-zinc-400 italic">Select who will manage this prospect. Directly assignable to Saif, Yohaan, or yourself.</p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                />
                <p className="text-[9.5px] text-zinc-400 italic">Lead will automatically pop up on your dashboard agenda on this date.</p>
              </div>
          ...
          {/* ── SECTION 2: Requirements (MULTI-SELECT CONFIGURATION CHIPS) ── */}
          {activeSection === 2 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="space-y-1.5">
              ...
              {/* MULTI-SELECT BHK CONFIGURATION CHIPS */}
              <div className="space-y-2">
                ...
                <p className="text-[9.5px] text-zinc-400 italic">Click chips to pick multiple suitable BHK layouts for this client.</p>
              </div>
